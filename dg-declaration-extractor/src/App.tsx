...
export default function App() {
  ...
  const [provider, setProvider] = useState<Provider>(() => {
    return (localStorage.getItem('dg_provider') as Provider) || 'openai';
  });
  ...
  useEffect(() => {
    ...
    localStorage.setItem('dg_api_key', apiKey);
  }, [provider, apiKey]);
        ...
        <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="p-2.5 rounded-full bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 transition-all active:scale-95 shadow-sm"
              title="API Settings"
            >
